...
@ComponentScan(basePackages ={"fr.abes.theses2ES.service", "fr.abes.theses2ES.entities"})
@EnableJpaRepositories(transactionManagerRef = "thesesTransactionManager", entityManagerFactoryRef = "thesesEntityManagerFactory",basePackages = "fr.abes.theses2ES.dao")
public class ThesesOracleConfig {
    ...
    public LocalContainerEntityManagerFactoryBean thesesEntityManagerFactory() {
        ...
        em.setPackagesToScan("fr.abes.theses2ES.entities");
